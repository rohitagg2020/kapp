...
func TestPreflightCRDUpgradeSafetyValidFieldChangeMaximumIncreased(t *testing.T) {
	env := BuildEnv(t)
	logger := Logger{}
	kapp := Kapp{t, env.Namespace, env.KappBinaryPath, logger}

	testName := "preflightcrdupgradesafetyvalidfieldchangemaximumincreased"
...
`
	...
	logger.Section("deploy app with CRD update that increases maximum constraint for an existing field, preflight check enabled, should not error", func() {
